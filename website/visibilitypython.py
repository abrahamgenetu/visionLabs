...
#Text to speech synthesising method using GTT libraary
...
#Web Scraping method to scrap links and parse content of pages using libraries like request, BeautifulSoup
def scrape(urls):
    ''' Scrapes links '''
...
#navingating links using speech
