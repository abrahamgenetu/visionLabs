const link = document.querySelectorAll('.locateme');
...
function onSuccess(position) {
    ...
    fetch(`https://api.opencagedata.com/geocode/v1/json?q=${latitude}+${longitude}&key=f0073ab6412943c6a8903c04b200bf58`)
        ...
        .then(response => response.json()).then(response => {
            ...
            button.innerText = `Your Location is: Around $ ${neighbourhood}, ${county} ${postcode}, ${country}`; //passing these value to the button innerText
